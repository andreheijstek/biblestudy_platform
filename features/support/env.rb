...
# your application behaves in the production environment, where an error
# page will be rendered instead.
#
...
begin
  ...
  raise 'You need to add database_cleaner to your gem_file '\
