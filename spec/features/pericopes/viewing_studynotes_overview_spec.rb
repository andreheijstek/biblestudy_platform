...
RSpec.feature "Users can view an overview of all studynotes" do
  ...
  scenario "sorted by pericopes name" do
    ...
    s1 = FactoryGirl.create(:study_note, title: "Jona", note: "Jona is bijzonder.")
    p1 = FactoryGirl.create(:pericope_by_name, name: 'Jona 1:1 - 1:10', biblebook_id: b1.id, study_note_id: s1.id)

    b2 = FactoryGirl.create(:biblebook, name: "Handelingen", booksequence: 1)
    s2 = FactoryGirl.create(:study_note, title: "Handelingen", note: "Handelingen ook.")
    p2 = FactoryGirl.create(:pericope_by_name, name: 'Handelingen 1:1 - 1:10', biblebook_id: b2.id, study_note_id: s2.id)
