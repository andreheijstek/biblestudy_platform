...
describe PericopeValidator do
  ...
  it 'accepts a pericope of one verse' do
    ...
    pericope.name = 'gen 1:1' # TODO: Hier gaat het mis. Als ik een .new doe
    # (of .create) dan gaat het goed, de hele initialize wordt aangeroepen en
    # vermoedelijk ook de validator maar als ik alleen een setter gebruik
