...
(function() {
  $(function() {
    return console.log('in mijn js');
  });

  $(".pericopes").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 1');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });

  $("#pericopes").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 2');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });

  $(".pericope").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 3');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });
  ...
  $("#pericope").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 4');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });

  $(".nested-fields").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 5');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });
  ...
  $("#nested-fields").on('cocoon:after-insert', function(e, inserted_item) {
    var num;
    console.log('in cocoon:after-insert 6');
    num = $('.pericopes').length;
    return inserted_item.find('.nested-fields').html('Field #' + num);
  });
